...
public class PostServiceMockTest {
    ...
    public void readPersonAndPost() throws Exception {
        ...
        given(personRepository.findPersonByFirstNameAndLastName(expectedPerson.getFirstName(), expectedPerson.getLastName())).willReturn(expectedPerson);
        ...
        verify(personRepository).findPersonByFirstNameAndLastName(expectedPerson.getFirstName(), expectedPerson.getLastName());
